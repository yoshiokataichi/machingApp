...
class BottomControllerView: UIView {
    ...
    let wuperLikeView = BottomButtonView(frame: .zero, width: 50, imageName: "superlike")
    ...
    override init(frame: CGRect) {
        ...
        let baseStackView = UIStackView(arrangedSubviews: [reloadView, nopeView, wuperLikeView, likeView, boostView])
