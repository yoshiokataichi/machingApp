...
class InfoCollectionViewCell: UICollectionViewCell {
    ...
    let residenceLabel = ProfileLabel(title: "移住地")
    let hobbyLabel = ProfileLabel(title: "趣味")
    let introductioonLabel = ProfileLabel(title: "自己紹介")
    ...
    let residenceTextField = ProfileTextField(placeholder: "移住地")
    ...
    override init(frame: CGRect) {
        ...
        let views = [[nameLabel, nameTextField], [ageLabel, ageTextField], [emailLabel, emailTextField], [residenceLabel, residenceTextField], [hobbyLabel, hobbyTextField], [introductioonLabel, introductionTextField]]
